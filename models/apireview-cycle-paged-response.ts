...
import { APIReviewCycle } from './apireview-cycle';

/**
 * class represents paged response.
 * @export
 * @interface APIReviewCyclePagedResponse
 */
export interface APIReviewCyclePagedResponse {
    /**
     * Gets or sets a value indicating whether this Keka.API.Web.Core.Response`1 is succeeded.
     * @type {boolean}
     * @memberof APIReviewCyclePagedResponse
     */
    'succeeded'?: boolean;
    /**
     ...
     * @type {Array<APIReviewCycle>}
     * @memberof APIReviewCyclePagedResponse
     */
    'data'?: Array<APIReviewCycle> | null;
    /**
