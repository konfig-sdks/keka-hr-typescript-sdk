 ...
 * @export
 * @interface ExpenseCategoryPagedResponse
 */
export interface ExpenseCategoryPagedResponse {
    /**
     * Gets or sets a value indicating whether this Keka.API.Web.Core.Response`1 is succeeded.
     * @type {boolean}
     * @memberof ExpenseCategoryPagedResponse
     */
    'succeeded'?: boolean;
    /**
     ...
     * @memberof ExpenseCategoryPagedResponse
     */
    'data'?: Array<ExpenseCategory> | null;
    /**
